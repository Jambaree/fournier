    ...
    <div className="mx-auto w-5/6 lg:w-2/3">
      {items?.map((block, i) => {
        ...
        switch (id) {
          case "text":
            return (
              <div key={i} className="prose max-w-none text-start pb-16">
            ...
            return (
              <div key={i} className="py-8">
                <div className="grid max-w-screen-lg gap-8 sm:mx-auto lg:grid-cols-2">
                  ...
                  <div className="order-2 prose max-w-none">
          ...
          case "gallery": {
            ...
            return (
              <div key={i} className="py-8">
                <div
                  className="grid max-w-screen-lg gap-8 sm:mx-auto"
                  style={{ gridTemplateColumns: `repeat(${b.columns || 3}, minmax(0, 1fr))` }}
                >
                  {b.gallery?.map((img, j) => (
                    <div key={j}>
                      <img
