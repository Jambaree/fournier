...
export default function Quote({ headline, text }: ACFBlock) {
  return (
    <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
      <div className="max-w-screen-sm sm:text-center sm:mx-auto">
        <div className="flex items-center justify-center w-16 h-16 mb-4 rounded-full bg-indigo-50 sm:mx-auto">
          <svg className="w-12 h-12 text-indigo-400" stroke="currentColor" viewBox="0 0 52 52">
            <polygon
              strokeWidth="3"
              strokeLinecap="round"
        ...
        {text && (
          <p
            className="text-base text-gray-700 md:text-lg sm:px-4"
